...
namespace Shutter.Managers
{
    public static class ImageManager
    {
        public static void SaveImage(HttpPostedFileBase hpf)
        {
            // Максимальные допустимые размеры картинки
            const int maxWidth = 4000;
            const int maxHeight = 3000;
            if (hpf != null && hpf.ContentLength != 0 && hpf.ContentLength <= 3072000)
            {
                            ...
                            new System.Drawing.Bitmap(hpf.InputStream, false))
                {
                 ...
                 System.Drawing.Drawing2D.InterpolationMode.HighQualityBicubic;
                            ...
                            string filePath =
                                ...
                                ConfigurationManager.AppSettings["ImagesPath"] + imageName + ext);
